        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:items-stretch">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <ChevronDown 
                          className={`w-5 h-5 text-bronze transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`} 
                        />
                      </div>
                      <AnimatePresence>
          ...
          <div className="bg-softwhite rounded-3xl shadow-2xl border border-charcoal/5 overflow-hidden flex flex-col">
            ...
            <div className="flex-1 relative min-h-[700px]">
              ...
              <iframe 
                src="https://calendly.com/signup90593/20min?embed_domain=localhost&embed_type=Inline" 
                width="100%" 
                height="100%" 
                frameBorder="0"
                scrolling="auto"
